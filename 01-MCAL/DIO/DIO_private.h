...
/*          Output modes(2MHZ)                        */
#define DIO_OUTPUT_2MHZ_GPIO_PUSH_PULL_MODE (0b0010)
#define DIO_OUTPUT_2MHZ_GPIO_OPEN_DRAIN_MODE (0b0110)
#define DIO_OUTPUT_2MHZ_AFIO_PUSH_PULL_MODE (0b1010)
#define DIO_OUTPUT_2MHZ_AFIO_OPEN_DRAIN_MODE (0b1110)

/*          Output modes(50MHZ)                        */
#define DIO_OUTPUT_50MHZ_GPIO_PUSH_PULL_MODE (0b0011)
#define DIO_OUTPUT_50MHZ_GPIO_OPEN_DRAIN_MODE (0b0111)
#define DIO_OUTPUT_50MHZ_AFIO_PUSH_PULL_MODE (0b1011)
#define DIO_OUTPUT_50MHZ_AFIO_OPEN_DRAIN_MODE (0b1111)
#endif